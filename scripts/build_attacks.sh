...
echo "            <p style=\"display: none;\" lang=\"en\" >Normals</p>" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"fr\" >Normaux</p>" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"alt\" >Normals</p>" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"jp\" >通常技</p>" >> attacks.html
echo "          </div>" >> attacks.html
echo "          <div class=\"tab\" id=\"tab-2\">" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"en\" >Aerials</p>" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"fr\" >Aerials</p>" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"alt\" >Aerials</p>" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"jp\" >空中攻撃</p>" >> attacks.html
echo "          </div>" >> attacks.html
echo "          <div class=\"tab\" id=\"tab-3\">" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"en\">Specials</p>" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"fr\">Speciaux</p>" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"alt\">Specials</p>" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"jp\">必殺技</p>" >> attacks.html
echo "          </div>" >> attacks.html
echo "          <div class=\"tab\" id=\"tab-4\">" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"en\">Misc</p>" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"fr\">Divers</p>" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"alt\">Misc</p>" >> attacks.html
echo "            <p style=\"display: none;\" lang=\"jp\">雑</p>" >> attacks.html
echo "          </div>" >> attacks.html
echo "        </div>" >> attacks.html
