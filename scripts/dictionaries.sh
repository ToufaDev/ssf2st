...
dic_jp[diagonal_jump_strong]="斜めＪ中Ｐ"
dic_jp[neutral_jump_strong]="垂直Ｊ中Ｐ"
dic_jp[diagonal_jump_fierce]="斜めＪ大Ｐ"
dic_jp[neutral_jump_fierce]="垂直Ｊ大Ｐ"
dic_jp[diagonal_jump_short]="斜めＪ小Ｋ"
dic_jp[neutral_jump_forward]="垂直Ｊ中Ｋ"
dic_jp[neutral_jump_short]="垂直Ｊ小Ｋ"
dic_jp[diagonal_jump_forward]="斜めＪ中Ｋ"
...
dic_jp[super_first_hit_punch]="最初のクレイジーバッファローのヒットＰ"
...
dic_jp[head_stomp_short]="鷹爪脚　小Ｋ"
dic_jp[head_stomp_bounce]="鷹爪脚　(当たって跳ね返ったとき)"
